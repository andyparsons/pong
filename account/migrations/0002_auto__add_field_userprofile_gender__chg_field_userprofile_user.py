...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'account_userprofile', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='m', max_length=140),
                      keep_default=False)


        # Changing field 'UserProfile.user'
        db.alter_column(u'account_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
