...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Invite'
        db.create_table(u'account_invite', (
            ...
            ('accepted_at', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'account', ['Invite'])

        # Adding field 'UserProfile.created'
        db.add_column(u'account_userprofile', 'created',
                      self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'UserProfile.modified'
        db.add_column(u'account_userprofile', 'modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'account_invite')

        # Deleting field 'UserProfile.created'
        db.delete_column(u'account_userprofile', 'created')

        # Deleting field 'UserProfile.modified'
        db.delete_column(u'account_userprofile', 'modified')


    models = {
        u'account.invite': {
            'Meta': {'object_name': 'Invite'},
            'accepted_at': ('django.db.models.fields.DateTimeField', [], {}),
